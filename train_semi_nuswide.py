...
#txt-model setting
flags.DEFINE_integer('txt_gc1', 400, 'Initial learning rate.')
#out-put dim
...
#learning rate
flags.DEFINE_float('lr_img', 0.0005, 'Initial learning rate.')
flags.DEFINE_float('lr_txt', 0.0005, 'Initial learning rate.')
...
balance_loss = 0.01 * img_balance + 0.01 * txt_balance
...
total_loss = img_loss + txt_loss + balance_loss + equality_loss + domain_class_loss_fake
...
for epoch in range(FLAGS.epochs):
    ...
    domain_loss_fake_, domain_loss_, equality_loss_ = sess.run([domain_class_loss_fake, domain_class_loss, equality_loss], feed_dict=feed_dict)
